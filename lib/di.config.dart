...
import 'package:bloc_skeleton/core/data/remote/interceptors/auth_interceptor.dart'
    as _i3;
import 'package:bloc_skeleton/core/di/local_module.dart' as _i13;
import 'package:bloc_skeleton/core/di/network_module.dart' as _i14;
...
import 'package:bloc_skeleton/src/auth/data/repository/auth_repository_impl.dart'
    as _i18;
import 'package:bloc_skeleton/src/auth/di/login_di_module.dart' as _i17;
...
import 'package:bloc_skeleton/src/example/data/repository/example_repository_impl.dart'
    as _i16;
import 'package:bloc_skeleton/src/example/di/example_di_module.dart' as _i15;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    final loginDiModule = _$LoginDiModule(this);
    ...
    gh.singleton<_i8.AuthService>(loginDiModule.authService(gh<_i6.Dio>()));
    ...
    gh.singleton<_i11.AuthRepository>(loginDiModule.authRepository);
    gh.factory<_i12.LoginUsecase>(
        () => loginDiModule.authLoginUseCase(gh<_i11.AuthRepository>()));
    return this;
  }
}
...
class _$LoginDiModule extends _i17.LoginDiModule {
  _$LoginDiModule(this._getIt);

  final _i1.GetIt _getIt;

  @override
  _i18.AuthRepositoryImpl get authRepository =>
      _i18.AuthRepositoryImpl(_getIt<_i8.AuthService>());
}
